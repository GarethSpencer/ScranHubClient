  ...
  return (
    <>
      ...
      <ul className="list-unstyled">
        <li>
          <h3 className="h6 fw-bold mb-1">Summary</h3>
          <p className="text-muted small mb-3">
          ...
          <p className="text-muted small mb-3">
            When viewing on a mobile device, the venues are shown as individual
            cards and are split into two sections (venue info and rating
            details) which are individually interactive. When viewing on a
            desktop device the venues are shown in a table, and all details are
            displayed at once by selecting the relevant row. Venue info is only
            available if the venue has been added using the Google search box.
            If so, you can view the venue opening times and map location, get
            directions, and visit the external website.
          </p>
        </li>
        <li>
          <h3 className="h6 fw-bold mb-1">Manage Venues</h3>
          <p className="text-muted small mb-3">
            Here you can add and remove venues, amend the details of every venue
            associated with the group, and provide your ratings for each venue.
            This is where you enter and update venue information. Group venues
            can be sorted in multiple ways, and can also be filtered by name or
            type using the input box at the top of the page.
          </p>
          <p className="text-muted small mb-3">
            To add a venue to the group, click the Add Venue button at the top
            of the page, then fill in the details. If a venue is added using the
            Google search box, an address will appear underneath the venue name
            and more information will be viewable in the venue summary page.
          </p>
          <p className="text-muted small mb-3">
            ...
            rating details) which are individually interactive. When viewing on
            a desktop device the venues are shown in a table, and all details
            are displayed at once by selecting the relevant row. To edit the
            details of a venue, or to delete a venue, select any existing venue
            from this view.
          </p>
          <p className="text-muted small mb-3">
            This page is also used to provide ratings for each venue. In mobile
            view, ratings can only be provided once a venue has been marked as
            visited, to optimise the user experience. In desktop view, venues
            can be rated at any time.
          </p>
        </li>
        <li>
          <h3 className="h6 fw-bold mb-1">Manage Options</h3>
          <p className="text-muted small mb-3">
            This page allows you to manage every set of options for the group.
            Each set of options is fully customisable per group. This means that
            each group can provide their own names for each set of options, such
            as the food quality and the venue type.
          </p>
          <p className="text-muted small mb-3">
        ...
        <li>
          <h3 className="h6 fw-bold mb-1">Group Members</h3>
          <p className="text-muted small mb-3">
